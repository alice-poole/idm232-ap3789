 ...
 * @return object - mysqli_result
 */
function edit_user($first_name_value, $last_name_value, $email_value, $id_value)
{
    global $db_connection;
    $query = 'UPDATE users';
    $query .= " SET first_name = '{$first_name_value}', last_name = '{$last_name_value}', email = '{$email_value}'";
...
/**
 * Verify provided password matches the password of the user
 * @param  string $first_name - first name of the user
 * @param  string $last_name - last name of the user
 * @param  string $email - email of the user
 * @param string $id_value - user ID
