<?php
/**
 * This file will hold all the functions for the project.
 */
...
function get_project_path()
{
    ...
    if ($APP_CONFIG['environment'] === 'development') {
        return $_SERVER['DOCUMENT_ROOT'] . '/idm232';
    } else {
        return $_SERVER['DOCUMENT_ROOT'] . '/idm232';
    }
}
 ...
 * @param string $value - The value to be sanitized to make sure it isn't code
